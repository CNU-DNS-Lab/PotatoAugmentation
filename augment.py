...
input_dir = f"./data/{dirname}/"  # Main input directory containing 'train' and 'test' folders
output_dir = f"./data/{dirname}_augmented_all/"  # Directory to save augmented images
file_extension = ".JPG"

# Define augmentation parameters
resize_dim = (224, 224)  # Image size needed for Transfer Learning
flip_horizontal = True  # Flip image horizontally
flip_vertical = True  # Flip image vertically
...
# Augment images in both 'train' and 'test' folders
